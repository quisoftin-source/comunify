...
function registerRoutes() {
    ...
    app.post("/notice/ai-generate", checkSocietyApproved, (req, res) => {
        ...
        if (prompt.includes('water')) {
            ...
            details = `Dear Residents,\n\nPlease note that there will be a temporary water supply shutdown tomorrow from 10:00 AM to 02:00 PM due to scheduled cleaning of the overhead society water tanks.\n\nPlease store sufficient water in advance to avoid inconvenience. We regret the disruption.\n\nManagement Office`;
        } 
            ...
            details = `Dear Residents,\n\nPlease read this notice regarding: ${req.body.prompt}.\n\nFor details, contact the society office.\n\nManagement Office`;
        }
